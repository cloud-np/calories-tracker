export const EXAMPLE_DATA = {
    ...
    // "theme": {
    //   "name": "dark",
    //   "grid": "{alpha: 0.1, color: \"#fff\", markerFillColor: \"#242f…}",
    //   "legend": "{background: \"#1c2533\", color: \"#fff\"}",
    //   "preview": "{brushBorderAlpha: 0, brushColor: \"#56626D\", handle…}",
    //   "xAxis": "{textAlpha: 0.6, textColor: \"#A3B1C2\"}",
    //   "yAxis": "{textAlpha: 0.6, textColor: \"#A3B1C2\"}",
    //   "title": "{color: \"#fff\"}",
